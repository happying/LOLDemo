...
#define UISCREENWIDTH  [UIScreen mainScreen].bounds.size.width // self.bounds.size.width//广告的宽度
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _titleBack = [[UIView alloc]initWithFrame:CGRectMake(0, frame.size.height - 30, UISCREENWIDTH * 5, 30)];
        _titleBack.backgroundColor =[UIColor blackColor];
        _titleBack.alpha=0.6;
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    _pageControl = [[MyPageViewController alloc] initWithFrame:CGRectMake( UISCREENWIDTH - 20*_pageControl.numberOfPages, HIGHT+UISCREENHEIGHT - 20, 20*_pageControl.numberOfPages, 20)];
    ...
    [_pageControl setImagePageForStateNormal:[UIImage imageNamed:@"pageControllerNornal.png"] StateHighlighted:[UIImage imageNamed:@"pageControllerH.png"]];
